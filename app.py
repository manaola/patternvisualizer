...
if pattern_file and fabric_hex and print_hex:
    ...
    pattern = pattern.point(lambda x: 0 if x < 128 else 255, '1')  # Binarize
    ...
    rgb_image[arr == 255] = print_rgb     # pattern (black areas)
    rgb_image[arr == 0] = fabric_rgb      # background (white areas)
